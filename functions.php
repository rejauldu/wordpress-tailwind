...
function learningWordPress_resources() {
	...
	wp_enqueue_script('script', get_template_directory_uri().'/assets/dist/bundle.min.js',['wp-element'], time(), true);
	wp_enqueue_style('main', get_template_directory_uri().'/assets/dist/main.css',[], time(), 'all');
